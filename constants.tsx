...
export const ASSETS = {
  ...
  PIZZA_FOGATA: "https://res.cloudinary.com/dkqocgknd/image/upload/f_auto,q_auto,w_800/v1771008397/lpet-eventos/pizza-fogata-v2.png",
};
...
export const ACTIVITIES = [
  ...
  { label: "Yoga y Bienestar", image: ASSETS.YOGA, icon: <Leaf className="w-5 h-5" />, rotate: true },
